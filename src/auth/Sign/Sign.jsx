...
const Sign = () => {
  ...
  const log = (e) => {
    ...
    if (flag) {
      ...
      navigate('/products');
      setOpenSnack({ open: true, html: `Welcome ${formData.name}`, severity: "success", time: "1000" })
    }
  }
   ...
   <div className={style.sign}>
     <div className={style.signContainer}>
      ...
      <form className={style.formContainer}>
        <div>
          <h1>Email-Id</h1>
          <input type='email' placeholder='email@abc.com' required autoFocus name='email' onChange={change} />
          <h1>User Name </h1>
          <input type='text' placeholder='username' required name='name' onChange={change} />
          <h1> Password </h1>
          <input type='password' placeholder='password' required name='pass' onChange={change} />
          <h1> Re-Enter Password </h1>
          <input type='text' placeholder='password' required name='repass' onChange={change} />
